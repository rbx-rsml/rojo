return function()
	...
	it("should throw when given a bogus ID", function()
		expect(function()
			reifyInstance(PatchSet.newEmpty(), {}, InstanceMap.new(), {}, "Hi, mom!", game)
		end).to.throw()
	end)
	...
	it("should return an error when given bogus class names", function()
		...
		local unappliedPatch = reifyInstance(PatchSet.newEmpty(), {}, instanceMap, virtualInstances, "ROOT", nil)
	...
	it("should assign name and properties", function()
		...
		local instanceMap = InstanceMap.new()
		local unappliedPatch = reifyInstance(PatchSet.newEmpty(), {}, instanceMap, virtualInstances, "ROOT")
